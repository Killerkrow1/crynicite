...
public class ModItems {
    ...
    public static final Item CRYSEUM_GREATHAMMER = registerItem("cryseum_greathammer",
            new GreatHammer(CryniciteToolMaterials.CRYSEUM, 10, -2.4f, new FabricItemSettings()));
    public static final Item CINICITE_KATANA = registerItem("cinicite_katana",
            new Katana(CryniciteToolMaterials.CINICITE, 10, -2.4f, new FabricItemSettings()));
    public static final Item CRYNICITE_CLEAVERSWORD = registerItem("crynicite_cleaversword",
            new CleaverSword(CryniciteToolMaterials.CRYNICITE, 10, -2.4f, new FabricItemSettings()));

    public static final Item CRYNICITE_SCISSORBLADES = registerItem("crynicite_scissorblades",
            new ScissorBlades(CryniciteToolMaterials.CRYNICITE, 10, -2.4f, new FabricItemSettings()));
    public static final Item CRYSEUM_SCISSORBLADES = registerItem("cryseum_scissorblades",
            new LeftScissorBlades(CryniciteToolMaterials.CRYSEUM, 10, -2.4f, new FabricItemSettings()));
    public static final Item CINICITE_SCISSORBLADES = registerItem("cinicite_scissorblades",
            new RightScissorBlades(CryniciteToolMaterials.CINICITE, 10, -2.4f, new FabricItemSettings()));
